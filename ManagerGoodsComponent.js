...
import { get_all_products, get_product_by_name } from '../features/shared/axiosRequests';
...
const mapStateToProps = state => {
 ...
 class ManagerGoods extends Component {
    ...
    componentDidMount() {
        this.setState({
            // goodsList: await get_all_products()
    ...
    async getGoodByName(e) {
        ...
        let res = await get_product_by_name(e.target.elements.name.value)
